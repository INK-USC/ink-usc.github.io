...
class PHP_Email_Form {
  ...
  public $to = false;
  public $from_first_name = false;
  public $from_last_name = false;
  public $from_email = false;
  public $from_company = false;
  ...
  public $error_msg = array(
    ...
    'invalid_from_first_name' => 'First Name is empty!',
    'invalid_from_last_name' => 'Last Name is empty!',
    'invalid_from_email' => 'Email from: is empty or invalid!',
    'invalid_subject' => 'Subject is empty!',
    'invalid_message' => 'Message is too short or empty!',
  ...
  public function send() {
    ...
    $from_first_name = filter_var( $this->from_first_name, FILTER_SANITIZE_STRING);
    $from_last_name = filter_var( $this->from_last_name, FILTER_SANITIZE_STRING);
    ...
    if( ! $from_first_name )
      $this->error .= $this->error_msg['invalid_from_first_name'] . '<br>';

    if( ! $from_last_name )
      $this->error .= $this->error_msg['invalid_from_last_name'] . '<br>';
    ...
    try {
      ...
      // Recipients
      $mail->setFrom( $this->mailer, $from_first_name . ' ' . $from_last_name );
      $mail->addAddress( $to );
      $mail->addReplyTo( $from_email, $from_first_name . ' ' . $from_last_name );
